...
Variant of L<ling2norm.xsl|/spliced2norm.xsl> which outputs plain (normalized) text
rather than XML.  Note that serial order of the output text is B<ALWAYS> in strict TEI-document
order, since this script does not respect any
...
prefer a "flat" serial document format such as L</XmlTokWrapFast> or L</XmlLing>
