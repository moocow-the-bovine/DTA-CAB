...
button in the L<link area|/Link Buttons>, which resolves to L<http://www.deutschestextarchiv.de/demo/cab/file|http://www.deutschestextarchiv.de/demo/cab/file>
...
the following command-line ought to suffice:
 ...
 curl -sSF "qd=<FILE.xml" -o "FILE.cab.xml" "http://www.deutschestextarchiv.de/demo/cab/query?fmt=tei"
...
In this case, you need to specify an appropriate "C<Content-Type>" header, e.g:
 ...
 curl -sSX POST -H "Content-Type: application/tei+xml; charset=utf8" --data-binary @"FILE.xml" -o "FILE.cab.xml" "http://www.deutschestextarchiv.de/demo/cab/query?fmt=tei"
