...
resembling L<this|http://www.deutschestextarchiv.de/demo/cab/query?q=EJn%20zamer%20Elephant%20gillt%20ohngef%C3%A4hr%20zweyhundert%20Thaler.%20Ceterum%20censeo%20Carthaginem%20esse%20delendam.>, identical to the results displayed in the data area for
...
##========================================================================
## I/O Formats: Text-based: TJ
=pod

=head4 L<TJ|DTA::CAB::Format::TJ>

Simple machine-readable "vertical" text format based on the L<TT|DTA::CAB::Format::TT>
...
##========================================================================
## I/O Formats: XML-based: XmlTokWrap
=pod
...
##========================================================================
## I/O Formats: XML-based: XmlTokWrapFast
=pod

=head4 L<XmlTokWrapFast|DTA::CAB::Format::XmlTokWrapFast>

Simple serial XML-based format as used by the L<DTA::TokWrap|http://odo.dwds.de/~moocow/software/dta-tokwrap/>
module.  Faster than L<XmlTokWrap|DTA::CAB::Format::XmlTokWrap>, but doesn't support all attributes.

=cut

##========================================================================
## I/O Formats: XML-based: TEI
=pod
...
using the L<XmlTokWrap|DTA::CAB::Format::XmlTokWrap> format.
Any C<E<lt>sE<gt>> or C<E<lt>sE<gt>> elements in the input will be ignored and the input will be (re-)tokenized.
Output data is itself parseable by L<DTA::CAB::Format::TEIws|DTA::CAB::Format::TEIws>.
...
as output by the L<TEI|DTA::CAB::Format::TEI> formatter class.
...
such as L<CSV|DTA::CAB::Format::CSV>.

=cut

##========================================================================
## I/O Formats: XML-based: TCF
=pod

=head4 L<TCF|DTA::CAB::Format::TCF>

Layer-based XML format used by CLARIN-D, in particlar by the
...
##========================================================================
## I/O Formats: XML-based: XML-RPC
=pod

=head4 L<XML-RPC|DTA::CAB::Format::XmlRpc>

Flexible but obscenely inefficient format used for data transfer
in the L<XML-RPC Protocol|https://en.wikipedia.org/wiki/XML-RPC>.
Avoid it if you can.

=cut

##========================================================================
## I/O Formats: Data-oriented
=pod
...
##========================================================================
## I/O Formats: Data-oriented: Storable
=pod
...
##========================================================================
## I/O Formats: Data-oriented: YAML
=pod

=head4 L<JSON|DTA::CAB::Format::YAML>
