...
$handler = $srv-E<gt>registerPathHandler($pathStr, \@handlerSpec)
$handler = $srv-E<gt>registerPathHandler($pathStr, $handlerObject)
...
undef = $srv-E<gt>denyClient($clientSock, $denyMessage)
