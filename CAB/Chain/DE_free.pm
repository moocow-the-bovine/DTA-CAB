## -*- Mode: CPerl -*-
## File: DTA::CAB::Chain::DE_free.pm
## Author: Bryan Jurish <moocow@cpan.org>
## Description: robust analysis: default chain (German, using only redistributable resources)

package DTA::CAB::Chain::DE_free;
...
DTA::CAB::Chain::DE_free - DTA-like analysis chain class for contemporary German, using only freely redistributable resources
...
suitable for analyzing contemporary German input using only
