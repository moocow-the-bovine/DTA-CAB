...
DTA::CAB::Analyzer::Soundex - phonetic digest analysis using Text::Phonetic::Soundex
...
DTA::CAB::Analyzer::Soundex is
a L<DTA::CAB::Analyzer::TextPhonetic|DTA::CAB::Analyzer::TextPhonetic>
analyzer class using the I<Soundex> algorithm, and storing
digests by default in the field 'soundex'.
