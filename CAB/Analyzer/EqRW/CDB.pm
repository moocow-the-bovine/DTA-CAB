...
DTA::CAB::Analyzer::EqRW::CDB inherits from
...
##----------------------------------------------------------------
## DESCRIPTION: DTA::CAB::Analyzer::EqRW::CDB: Constructors etc.
=pod
