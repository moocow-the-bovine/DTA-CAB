...
DTA::CAB::Analyzer::EqPho::CDB - DB dictionary-based phonetic equivalence expander
...
=head1 SYNOPSIS
 ...
 $eqp = DTA::CAB::Analyzer::EqPho::CDB->new(%args);
...
##----------------------------------------------------------------
## DESCRIPTION: DTA::CAB::Analyzer::Dict::CDB: Globals
=pod
...
DTA::CAB::Analyzer::EqPho::CDB inherits from
